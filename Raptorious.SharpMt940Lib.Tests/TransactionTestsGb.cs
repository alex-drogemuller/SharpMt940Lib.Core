...
{
    [TestFixture]
    public class TransactionTestsGb
    {
        [Test, Category("Issue2")]
        public void EntryMonthAndEntryDayAvailableText()
        {
            var transaction = new Transaction("1312231223DR0.95N011NONREF", new Currency("GBP"));
        ...
        {
            var transaction = new Transaction("131223DR0.95N011NONREF", new Currency("GBP"));
        ...
        public void EntryMonthOptionalText()
        {
            Assert.Throws<InvalidExpressionException>(() =>
                new Transaction("13122323DR0.95N011NONREF", new Currency("GBP")));
        }
        ...
        {
            Assert.Throws<InvalidExpressionException>(() =>
                new Transaction("13122312DR0.95N011NONREF", new Currency("GBP")));
        }
        ...
        {
            var transaction = new Transaction("1407010701C388.15NDIV0597894779", new Currency("GBP"));
        ...
        public void WithSupplementaryDetails_IsParsedCorrectly()
        {
            var expectedTransaction = ExpectedSwiftTransaction.CreateExpected(new DateOnly(2015, 1, 26), DebitCredit.Credit,
                "R", "GBP", 18790.00M, "NTRF", "PON0000002534162", null, "Inward Payment", "");
        ...
        {
            var expectedTransaction = ExpectedSwiftTransaction.CreateExpected(new DateOnly(2015, 1, 26), DebitCredit.Credit,
                "R", "GBP", 18790.00M, "NTRF", "PON0000002534162", null, "", "");

            var transaction = new Transaction("1501260126CR18790.00NTRFPON0000002534162", new Currency("GBP"), Mt940Test.GbCultureInfo);
